class GiclClaim < ApplicationRecord
  ...
  def polbasic
    GipiPolbasic.find_by(line_cd: self.line_cd, subline_cd: self.subline_cd, source: self.source, issue_yy: self.issue_yy, pol_seq_no: self.pol_seq_no, renew_no: self.renew_no)
  end
